...
| product_name | string | Name of the product, if available | None |
| category_tag | string | Category of the product, only for "raw" products. Uses Open Food Facts taxonomy | None |
| labels_tags | string | Labels of the product, only for "raw" products. Uses Open Food Facts label taxonomy | None |
| origins_tags | string | Origins of the product, only for "raw" products. Uses Open Food Facts origin taxonomy | None |
| price | float | Price of the product, with discount if any | 1.25 |
| price_is_discounted | bool | Whether the price is discounted | False |
| price_without_discount | float | Price without discount, null if not discounted | NaN |
...
| location_website_url | string | Website URL of the store if available | None |
| location_source | string | Source of the location info | None |
