...
Les chaines de caractères contenues dans la colonne `product_name` ont été minusculisées pour éviter les potentiels doublons dans les noms des produits.<br>
